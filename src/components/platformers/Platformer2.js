...
function Platformer2({ goToNextLevel }) {
  let seconds = 0;
  let keyEndtime = 0;
  let player;
  let computer;
  ...
  const setup = (p5, canvasParentRef) => {
    ...
    platforms.push(new Platform(100, 340, 75, 25));
    platforms.push(new Platform(175, 250, 25, 240));
    platforms.push(new Platform(300, 290, 120, 25));
    platforms.push(new Platform(500, 220, 120, 25));
    ...
    spikes.push(new Spikes(p5, 360, 430));
    ...
    spikes.push(new Spikes(p5, 585, 430));
    spikes.push(new Spikes(p5, 630, 430));

    enemies.push(new Enemy(p5, 555, 200, 1, 50));

    lasers.push(new Laser(340, 10, 280, 2));
  };
