...
function Platformer5({ goToNextLevel }) {
  let seconds = 0;
  let keyEndtime = 0;
  let player;
  let computer;
  ...
  const setup = (p5, canvasParentRef) => {
    ...
    platforms.push(new Platform(300, 340, 120, 25));
    platforms.push(new Platform(500, 340, 120, 25));
    platforms.push(new Platform(100, 240, 120, 25));
    platforms.push(new Platform(300, 240, 120, 25));
    platforms.push(new Platform(500, 240, 120, 25));
    ...
    enemies.push(new Enemy(p5, 555, 220, 1, 50));
    enemies.push(new Enemy(p5, 155, 220, 1, 50));

    lasers.push(new Laser(340, 10, 130, 1));
    lasers.push(new Laser(340, 265, 75, 2));
  };
  ...
  const draw = (p5) => {
    ...
    if (keyTouched && seconds < keyEndtime) {
      ...
      p5.text("The key is 'WIN'", 395, 245);
