...
function Platformer3({ goToNextLevel }) {
  let seconds = 0;
  let keyEndtime = 0;
  let player;
  let computer;
  ...
  const draw = (p5) => {
    ...
    if (keyTouched && seconds < keyEndtime) {
      ...
      p5.text("The key is '3102'", 395, 245);
